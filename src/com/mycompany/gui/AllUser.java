 ...
 * @author hamza
 */
public class AllUser extends BaseForm {

    Form current;
    ImageViewer imgv;

    public AllUser(Resources res) {
...
//        add(Ajouter);
        ...
        ServiceUser re = new ServiceUser();
        Users = re.affichageUser();

        for (User fi : Users) {
            Container ct = new Container(BoxLayout.y());
         Label l1 = new Label("id: " + fi.getId(), "SmallLabel");

            Label l2 = new Label("nom: " + fi.getNomUtil(), "SmallLabel");
            Label l3 = new Label("prenom: " + fi.getPrenomUtil(), "SmallLabel");
            Label l4 = new Label("email : " + fi.getEmail(), "RedLabel");
           //Label l5 = new Label("tel  : " + fi.getTel(), "RedLabel");
            //Label l6 = new Label("password  : " + fi.getPassword(), "RedLabel");
        //  Label l7 = new Label("roles  : " + fi.getRoles(), "RedLabel");

            Label l6 = new Label("adresse  : " + fi.getAdresse(), "RedLabel");
...
//                public void actionPerformed(ActionEvent evt) {
//
//                    new EditReclamation(res, current, fi).show();
//                }
//
//            });
...
//
//                  if( ServiceReclamation.getInstance().deleteReclamation(fi))
//                            {
