...
public class AllReclamation extends BaseForm {
    ...
    public AllReclamation(Resources res) {
        ...
        Reclamations = re.affichageReclamation();
       ...
       //   Label l1 = new Label("id: " + fi.getId(), "SmallLabel");
            ...
            Label l3 = new Label("prenom: " + fi.getPrenom(), "SmallLabel");
            Label l4 = new Label("email : " + fi.getEmail(), "RedLabel");
//            Label l5 = new Label("tel  : " + fi.getTel(), "RedLabel");
            Label l6 = new Label("description  : " + fi.getDescription(), "RedLabel");
            Label l7 = new Label("etat  : " + fi.getEtat(), "RedLabel");
